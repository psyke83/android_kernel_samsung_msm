...
#ifdef CONFIG_MAX8899_CHARGER
	PCOM_VREG_LDO(maxldo03, 42, NULL,  OUT3000uV,  OUT3000uV, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(maxldo04, 43, NULL,  OUT2800uV,  OUT3000uV, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(maxldo05, 44, NULL,  OUT1800uV,  OUT3000uV, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(maxldo06, 45, NULL,  OUT2600uV,  OUT3000uV, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(maxldo08, 47, NULL,  OUT2600uV,  OUT2800uV, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(maxldo09, 48, NULL,  OUT2800uV,  OUT2800uV, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(maxldo10, 49, NULL,  OUT1200uV,  OUT2800uV, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(maxldo12, 51, NULL,  OUT2600uV,  OUT2600uV, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(maxldo13, 52, NULL,  OUT3300uV,  OUT3300uV, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(maxldo14, 53, NULL,  OUT2600uV,  OUT2600uV, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(maxldo15, 54, NULL,  OUT1800uV,  OUT2850uV, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(maxldo16, 55, NULL,  OUT2850uV,  OUT3000uV, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(maxldo17, 56, NULL,  OUT3000uV,  OUT3300uV, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(maxldo18, 57, NULL,  OUT3300uV,  OUT3300uV, 0, -1, 0, 0, 0, 0),
	PCOM_VREG_LDO(maxldo19, 58, NULL,  OUT2600uV,  OUT3300uV, 0, -1, 0, 0, 0, 0),
#endif
};
