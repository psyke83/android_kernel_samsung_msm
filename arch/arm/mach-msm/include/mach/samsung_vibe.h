...
#define HWIO_GP_NS_REG_CORE_CLK_INV_BMSK                                           0x400
#define HWIO_GP_NS_REG_CORE_CLK_INV_SHFT                                             0xa
#define HWIO_GP_NS_REG_CORE_CLK_BRANCH_ENA_BMSK                                    0x200
#define HWIO_GP_NS_REG_CORE_CLK_BRANCH_ENA_SHFT                                      0x9
